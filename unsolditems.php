...
<html>
  ...
  <body>
    ...
    //while ($result = mysql_fetch_assoc($q)) {
      ...
      $totalsale = 0;
      $divide = 100.00;
      $q2 = mysqli_query($connection, "SELECT * FROM $Adbi WHERE price=0.00 ORDER BY seller_id;");
      ...
      while ($r2 = mysqli_fetch_assoc($q2)) {
        ...
        //if ($r2["price"] && $result["buyer_commission"] != 0) $totalcomm += round($r2["price"] * $result["buyer_commission"]) / $divide;
        //echo "        <td class=\"right\">".(($result["seller_commission"] && $result["seller_commission"] != 0) ? "%" .$result["seller_commission"] : "NO COMIISSION")."</p>\n";
        ...
        //if ($r2["price"] * $result["buyer_commission"] * $result["tax"] != 0) $totalsale += round($r2["price"] * $r2["qty"] * $result["buyer_commission"] / $divide, 2) + round($r2["qty"] * $r2["price"] * $result["tax"] / $divide, 2) + round($r2["price"] * $r2["qty"], 2);
        echo "      </tr>\n";
      }
