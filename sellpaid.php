...
$lotSellercheckID = filter_input(INPUT_GET, "lotSellercheckID", FILTER_SANITIZE_SPECIAL_CHARS);
...
<html>
  ...
  <body style="font-size: xx-large;">
    <p>Are you sure you want to mark seller <?php echo $lotSellerID;?> as paid with check #<?php echo $lotSellercheckID;?>?</p>
    <p>This user sold <?php echo $blots; ?> 
      items.
    </p>
    <form action="checkoutseller.php?action=sellpaid" method="POST" style="display: inline;" >
      <input type="hidden" name="lotSellerID" value="<?php echo $lotSellerID; ?>"/>
      <input type="hidden" name="lotSellercheckID" value="<?php echo $lotSellercheckID; ?>"/>
